...
Keywords: Covariance test, hypothesis-testing, Testing, simulation, empirical, covariance, covariance matrix, multivariate', 'treatment

See also: SMSanovapull, SMSdete2pull, SMSdeterpull, SMSlinregpull, SMSscabank45, SMScovbank

Author: Jaroslav Pazdera, Awdesch Melzer
